...
class ImageTransformer(object):
    ...
    def __init__(self, image_path, shape, image=None):
        self.image_path = image_path
        self.image = load_image(image_path, shape, image)
    ...
    def shear_horizontally(self, shear=0):
    ...
    def shear_vertically(self, shear=0):
